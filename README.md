...
**Status:** **v3.1.0** · 23 skills · [Release v3.1.0](https://github.com/HeyEddi-com/skills/releases/tag/v3.1.0)
...
```bash
npx skills add https://github.com/HeyEddi-com/skills/tree/v3.1.0 -a cursor -y --skill '*'
```
