...
**Status:** **v3.4.1** · 27 skills · [skills-registry.json](skills-registry.json)
...
```bash
npx skills add https://github.com/HeyEddi-com/heyeddi-skills/tree/v3.4.1 -a cursor -y --skill '*'
```
